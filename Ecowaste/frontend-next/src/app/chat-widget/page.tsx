...
export default function ChatWidgetEmbed() {
  ...
  return (
    <div className="flex flex-col w-full h-screen bg-card text-card-foreground font-sans overflow-hidden">
      <header className="px-4 py-3 border-b flex items-center justify-between bg-card shrink-0">
